...
class BridgeTests:
    def test_get_issue(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "issue.yaml")):
            self.assertIsNotNone(self.bridge.get_issue("TP-9"))

    def test_get_statuses(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "status.yaml")):
            self.assertIsNotNone(self.bridge.get_statuses())

    def test_get_projects(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "project.yaml")):
    ...
    def test_get_issue_types(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "types.yaml")):
    ...
    def test_get_filters(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "filters.yaml")):
            self.assertIsNotNone(self.bridge.get_filters())

    def test_search_free_text(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "search.yaml")):
            self.assertTrue(
                len(
    ...
    def test_create_issue(self):
        with vcr.use_cassette(os.path.join(self.vcr_directory, "create.yaml")):
            self.assertIsNotNone(
